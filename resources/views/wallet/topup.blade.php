            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <form method="POST" action="{{ route('wallet.topup.store') }}" enctype="multipart/form-data"
                            ...
                            <div>
                                ...
                                <div class="mt-1.5 flex items-center justify-between text-xs">
                                    <span class="text-slate-500">Min: Rp
                                        {{ number_format($minAmount ?? 1000) }}</span>
                                    <span class="text-slate-500">Max: Rp
                                        {{ number_format($maxAmount ?? 100000000) }}</span>
                                </div>
                                @error('amount')
                ...
                <div class="space-y-6">
                    ...
                    <div class="rounded-2xl bg-blue-50 dark:bg-blue-900/30 p-4">
                        <div class="flex">
                            ...
                            <div class="ml-3 flex-1">
                                <h3 class="text-sm font-medium text-blue-800 dark:text-blue-300">Informasi Penting
                                </h3>
                    ...
                    <div
                        ...
                        <div class="p-4 border-b border-slate-200/60 dark:border-white/10">
                            <h3 class="font-medium">Riwayat Permintaan Top Up</h3>
                        </div>
                                    ...
                                    <tbody>
                                        @foreach ($topups as $topup)
                                            <tr class="border-t border-slate-200/60 dark:border-white/10">
                                                <td class="px-4 py-3">
                                                    <span class="font-mono">{{ $topup->reference }}</span>
                                                </td>
